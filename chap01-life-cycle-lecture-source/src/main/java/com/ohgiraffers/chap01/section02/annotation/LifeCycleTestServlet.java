...
public class LifeCycleTestServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        super.init(config);
        System.out.println("annotation 매핑 init() 메소드호출" + initCount);
    }
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        * */
        System.out.println("annotation 매핑 service() 메소드호출" + serviceCount);
    }

    @Override
    public void destroy() {
        super.destroy();
        System.out.println("annotation 매핑 destroy() 메소드호출" + destroyCount);
    }
}
